...
data class MessageData(
    ...
    @SerializedName("replyTo") val replyTo: String = "", // 답장 상대의 uid
    @SerializedName("replyComment") val replyComment: String = "", // 답장 상대의 메시지 내용
    @SerializedName("replyType") val replyType: MessageType = MessageType.Text,  // 답장 상대의 메시지 타입
    @SerializedName("replyKey") val replyKey: Long = 0L // 로컬 db Key 값으로 쓸것 (고유값인 time)
)
