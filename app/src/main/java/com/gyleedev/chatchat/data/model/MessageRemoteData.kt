...
data class MessageRemoteData(
    ...
    @SerializedName("replyComment") val replyComment: String = "",
    @SerializedName("replyType") val replyType: MessageType = MessageType.Text,
    @SerializedName("replyKey") val replyKey: Long = 0L
)
