...
fun RelatedUserLocalData.toEntity(): UserEntity = UserEntity(
    id = id,
    name = name,
    email = email,
    uid = uid,
...
fun UserEntity.toRelationLocalData(): RelatedUserLocalData = RelatedUserLocalData(
    id = id,
    name = name,
    email = email,
    uid = uid,
...
fun UserEntity.toModel(): UserData = UserData(
    name = name,
    email = email,
    uid = uid,
    picture = picture,
...
fun UserData.toEntityAsFriend(): UserEntity = UserEntity(
    id = 0L,
    name = name,
    email = email,
    uid = uid,
